...
import HobbySmallGroupPage from "./components/views/HobbySmallGroupPage/HobbySmallGroupPage";
        ...
        <div className="App">
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/category/:category/hobbySmallGroupPage" element={<HobbySmallGroupPage/>} />
